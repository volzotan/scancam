...
#define cpu_map_h
  ...
  // COMMENT VOLZO: dir and step pins are switched on the cheap "CNC engraver shield" version
  // of the CNC shield. The "CNC engraver shield" is not in fact a shield but has headers for
  // directly inserting an Arduino Nano
